    ...
    with gr.Tab('Notebook', elem_id='notebook-tab'):
        ...
        with gr.Row():
            with gr.Column(scale=4):
                ...
                with gr.Tab('Logits'):
                    with gr.Row():
                        with gr.Column(scale=10):
                            shared.gradio['get_logits-notebook'] = gr.Button('获取下一个 Token 概率')
                ...
                with gr.Tab('Tokens'):
                    shared.gradio['get_tokens-notebook'] = gr.Button('获取 Token ID')
                ...
                with gr.Row():
                    ...
                    shared.gradio['Regenerate-notebook'] = gr.Button('重生成', elem_classes='small-button')
