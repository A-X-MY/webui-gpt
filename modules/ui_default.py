    ...
    with gr.Tab('默认', elem_id='default-tab'):
        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    shared.gradio['prompt_menu-default'] = gr.Dropdown(choices=utils.get_available_prompts(), value='None', label='提示词', elem_classes='slim-dropdown')
            ...
            with gr.Column():
                ...
                with gr.Tab('Logits'):
                    with gr.Row():
                        with gr.Column(scale=10):
                            shared.gradio['get_logits-default'] = gr.Button('获取下一个 token 概率')
                ...
                with gr.Tab('Tokens'):
                    shared.gradio['get_tokens-default'] = gr.Button('获取输入的 token ID')
